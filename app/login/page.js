...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!res.ok) {
            ...
            await router.push(next || '/admin');
            toast.success('Login Successful!');
        }
    };

    return (
        <div className="mx-auto montserrat" style={{ paddingTop: '70px', overflowY: 'hidden' }}>
                        ...
                        <div className="flex items-center w-full max-w-md px-6 py-16 mx-auto lg:w-2/4">
                            <div className="flex-1">
                                <div className="text-center">
                                    <h2 className="text-4xl font-bold text-center text-zinc-700">Devashree PEV</h2>
