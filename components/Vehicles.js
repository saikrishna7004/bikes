    ...
    return (
        <div className="bg-gray-100 py-10">
            <div className="text-center mb-8">
                <h3 className="md:text-5xl text-2xl font-bold md:mx-20 mx-4 leading-6">Redefine Your Ride: Discover the<br/> Next Generation of Electric Mobility</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 container mx-auto custom-container">
                {vehicles.map((vehicle, index) => (
                    <div key={index} className="bg-white px-4 py-20 text-center">
                        ...
                        <img className="my-10 w-100 h-100 mx-auto object-contain rounded" src={vehicle.imgSrc} alt={vehicle.name} />
